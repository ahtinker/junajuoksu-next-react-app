...
const StationList = () => {
    ...
    return (
        <article ref={inputRef} className="panel is-primary has-text-left  mb-6" style={{ maxWidth: "500px", margin: "0 auto", width: "100%", border: "1px solid var(--bulma-border)", backdropFilter: "blur(30px)" }}>
            <div className="p-4">
